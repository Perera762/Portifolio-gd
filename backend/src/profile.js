export const profile = {
  ...
  skills: [
    {
      id: "01",
      title: "Front-End",
      text: "HTML, CSS e JavaScript aplicados a interfaces funcionais e bem construídas.",
    },
    {
      id: "02",
      title: "Hardware & Infra",
      text: "Montagem, manutenção e suporte técnico em equipamentos de TI e infraestrutura.",
    },
    {
      id: "03",
      title: "Lógica & Backend",
      text: "Base em Python e lógica de programação, com fundamentos em Java.",
    },
    {
      id: "04",
      title: "Segurança",
      text: "Fundamentos de segurança da informação aplicados ao dia a dia técnico.",
    },
  ],
  experience: [
    {
      ...
      description:
        "Suporte técnico N1, N2 e N3, manutenção do site interno da empresa, desenvolvimento em PHP, manipulação de banco de dados e segurança.",
      contract: "CLT",
    },
    {
      id: "td",
      ...
      description:
        "Montagem, manutenção e suporte técnico em equipamentos de TI e infraestrutura.",
      contract: "CLT",
    },
    {
      id: "freelance",
      ...
      description:
        "Montagem, manutenção e reparo de computadores e periféricos como freelancer.",
      contract: "Freelance",
    },
  ],
  education: {
  ...
  projects: [
    {
      ...
      description:
        "Sistema de agendamento de consultas online, desenhado no Figma e implementado como aplicação web funcional — do wireframe à interface navegável.",
  ...
  cinematic: {
    frameCount: 240,
    framePattern: "/frames/ezgif-frame-{{n}}.jpg",
    beats: [
      {
        id: "open",
        start: 0,
        end: 0.16,
        kicker: "PORTFÓLIO — SÃO PAULO, BR",
        title: "GARANTO\nCÓDIGO.\nE QUALIDADE",
        body: "Role para entrar no retrato.",
      },
      {
        id: "approach",
        start: 0.16,
        end: 0.38,
        kicker: "01 — APROXIMAÇÃO",
        title: "QUALIDADE\nCOMEÇA NO\nDETALHE",
        body: "O mesmo olhar que encontra falha no hardware encontra falha no código.",
      },
      {
        id: "focus",
        start: 0.38,
        ...
        kicker: "02 — FOCO",
        title: "QA · TESTES\nESTABILIDADE",
        body: "Validação antes da produção. Experiências fluidas, sistemas confiáveis.",
      },
      {
        id: "close",
        start: 0.62,
        ...
        kicker: "03 — CLOSE",
        title: "ENXERGO\nFALHAS ANTES\nDA PRODUÇÃO",
        body: "Ciência da Computação · Front-end & QA Tester",
      },
      {
        id: "hold",
        start: 0.84,
        end: 1,
        kicker: "Nº 004 — G. PEREIRA DIAS",
        title: "GUSTAVO\nPEREIRA\nDIAS",
        body: "São Paulo, BR — 23.55°S · 46.63°O",
      },
    ],
  },
};
